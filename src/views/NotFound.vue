<template>
  <!-- This component is intentionally empty as it immediately redirects -->
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center text-center p-4">
    <div class="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md shadow-lg">
