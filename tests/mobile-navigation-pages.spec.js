...
test.describe('Mobile Navigation - Page Navigation and Logout', () => {
  ...
  test('should navigate through pages via mobile menu and logout successfully', async ({ page }) => {
    ...
    async function navigateViaMenu(pageName, expectedText, expectedUrl) {
      ...
      // Verify we're on the expected page by waiting for network and animation to complete
    ...
    try {
      ...
      console.log('⚠️ Could not detect standard login URL pattern, checking for login button instead')
    }
